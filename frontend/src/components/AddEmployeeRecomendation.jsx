...
function AddEmployeeRecommendation({ employeeName }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post('http://localhost:8080/api/v1/employee/employee-recommendation', {
        employeeName,
  ...
  return (
    <div className="max-w-md mx-auto">
      <h2 className="text-2xl font-semibold mb-4">Add Employee Recommendation</h2>
      {message && (
        <div
          className={`mb-4 ${
      ...
      <form onSubmit={handleSubmit}>
        <div className="mb-2">
          ...
          <input
            ...
            onChange={() => setIsRecommendedForIncrement(!isRecommendedForIncrement)}
        ...
        <div className="mb-4">
          ...
          <input
            ...
            onChange={() => setIsRecommendedForPromotion(!isRecommendedForPromotion)}
            className="custom-checkbox"
          />
